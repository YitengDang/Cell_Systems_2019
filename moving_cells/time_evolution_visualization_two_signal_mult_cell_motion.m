...
[h_cells, h_borders] = reset_cell_figure(hin, pos, rcell);
t = 0;
update_figure_periodic_scatter(h_cells, cells, t, disp_mol, showI, a0, dist);
%update_figure_periodic_cell_motion(h_cells, h_borders, cells, t, disp_mol, showI, a0, dist, pos)
