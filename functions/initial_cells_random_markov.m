function [pos, dist, fN0, rejections] = initial_cells_random_markov(...
    n, mcsteps, rcell, nodisplay, periodic_bc)
...
% Calculate distance
dist = calc_dist(x, y, Lx, Ly, periodic_bc);
dist = round(dist, 10);
%pos = [x(:) y(:)];
...
while step < mcsteps
    ...
    % Calculate distance
    dist_new = calc_dist(x_new, y_new, Lx, Ly, periodic_bc);
