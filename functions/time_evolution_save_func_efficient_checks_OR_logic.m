function [cells_hist, period, t_onset] = time_evolution_save_func_efficient_checks_OR_logic(...
    ...
    t_onset = Inf; 
    [cellsOut, changed] = update_cells_two_signals_finite_Hill_new(cells, distances, M_int, a0,...
