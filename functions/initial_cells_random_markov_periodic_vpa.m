function [pos, dist] = initial_cells_random_markov_periodic_vpa(gz, mcsteps, rcell, nodisplay, vpa_digits)
...
fprintf('digits ini = %d \n', digits);
old_digits = digits(vpa_digits);
fprintf('digits set = %d \n', digits);
...
% reset to old precision
new_digits = digits(old_digits);
fprintf('digits final = %d \n', digits);
