function [h_cells, h_borders, a0_px] = reset_cell_figure_cell_growth(ax, pos, rcell_all)
    % Takes into account cell growth
    ...
    h_cells = scatter(pos(:,1), pos(:,2), (2*Rcell_px_all).^2, c_all, 'filled', 'o');
    h_borders = scatter(pos(:,1), pos(:,2), (2*Rcell_px_all).^2, clr_k, 'o'); % plot cell boundaries
