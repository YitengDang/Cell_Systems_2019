...
setwd("D:\\Documenten\\Studie\\Master\\Internship Delft\\test") # Change to folder containing csv file
...
M0p5 = glm(TW ~ p1, family = 'binomial',data = d)
M0p6 = glm(TW ~ p1 + p2, family = 'binomial',data = d)
...
summary(M1)
anova(M0,M0p5,M0p6,M1,test = 'Chisq')
