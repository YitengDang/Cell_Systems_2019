function [trav_wave, trav_wave_2]  = travelling_wave_test_rounded6(cells_hist, a0, this_period, this_t_out,dist)
   ...
   %%
    ...
    if mod(this_period, gz)==0
        ...
        for i1=1:this_period+1
            ...
            cells = cells_hist{i2};
            p_last(i1, :) = round(sum(cells, 1)/N,6); 
            for j1=1:s
        ...
        % If there are multiple unique values for I, there could still be a wave.
