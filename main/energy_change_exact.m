...
% save the histogram
name = sprintf('N%d_n%d_a0%d_K_%d_Son_%d_bins_%d', ...
    N, iniON, 10*a0, K, Son, nbins);
out_file = fullfile(pwd,'figures', 'energy_change', 'no_noise', ...
...
fname_str = sprintf('N%d_n%d_a0%d_K_%d_Son_%d', ...
    N, iniON, 10*a0, K, Son);
fname = fullfile(pwd, 'data', 'energy_change','no_noise', ...
