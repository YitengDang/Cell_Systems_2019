...
% integral approach and a continuous of cells (see appendix of the thesis).
clear variables
close all
...
gridsize = 21;
N = gridsize^2;
a0_vec = linspace(0.1, 4, 50); % all a0 to test
...
for i = 1:numel(a0_vec)
    ...
    % Estimation by considering continuous average after first neighbors
    L0 = 1.5*a0;
    N0 = 7;
...
% Plot the error made by estimating with the integral
h2 = figure(2);
...
% Make inset for smaller values of a0
xlim([a0_vec(1) 1])
