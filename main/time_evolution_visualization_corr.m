...
%%
% correlation function together
h2=figure(2);
hold on
[~, dist_vals] = correlation_func(dist, cells);
corr_func = zeros(t, numel(dist_vals));
for i=1:t
    cells = cells_hist{i};
    [corr_func(i, :), dist_vals] = correlation_func(dist, cells);
    h2;
    plot(dist_vals, corr_func(i, :));
end
