...
path = 'N:\tnw\BN\HY\Shared\Yiteng\two_signals\sweep K22 new lattice';
...
% save paths
save_folder_data = 'N:\tnw\BN\HY\Shared\Yiteng\two_signals\sweep K22 new lattice\analyzed_data';
...
save_path_fig = save_folder_data;
% Parameters
%N = [5 8 10 12 13 15 20].^2;
N = 625; %225;
nN = numel(N);

K_all = [5:25]; %[7:11 15 20:24];
nK = numel(K_all);
a0 = 0.5;
nruns = 100;
%Ilist = 0:0.1:0.7;
...
fname = fullfile(save_folder_data, strcat(fname_str, '_data'));
