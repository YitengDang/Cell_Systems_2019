...
for loop_idx=1:numel(x_found)
    ...
    % ---Original predictor set (testing only specific conditions for each
    % wave_type)-----------------------------------------------------------
    %
    load_folder = 'N:\tnw\BN\HY\Shared\Yiteng\two_signals\trav_wave_stability_general';
    subfolder = 'run2'; %'run3_vary_a0_lambda12';
    ...
    %{
    load_folder = 'N:\tnw\BN\HY\Shared\Yiteng\two_signals\trav_wave_stability_general';
    subfolder = 'run2_rerun'; %'run3_vary_a0_lambda12';
    fname_str_pred = sprintf('trav_wave_conditions_check_wave_num_%d_type_%d_network_%d_states_%d_%d_%d_%d',...
