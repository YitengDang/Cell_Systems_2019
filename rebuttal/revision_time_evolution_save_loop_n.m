...
for iniON = nrange
    ...
    %fname = fullfile(pwd, 'rebuttal', 'trajectories', 'N121_a0_1p5_figS4',... 
    %    sprintf('K%d_Con%d', K, Con), strcat(fname_str,'-v',int2str(i),'.mat'));
    %fname = fullfile(pwd, 'rebuttal', 'trajectories', 'Fig_4_new_alt', foldername,... 
