...
%}
if qsave
    fname = strrep(sprintf('Wang_Landau_normalised_N%d_p0_%.2f_a0_%.2f_f0exp%d_ffinalexp10e-%d_pflat%.1f_%dbins',...
        N, p, a0, c1, c2, p_flat, nbins), '.', 'p');
