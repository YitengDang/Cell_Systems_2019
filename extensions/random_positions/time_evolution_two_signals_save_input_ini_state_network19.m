...
% mcsteps_all = round(10.^setdiff(1:0.2:3, 1:3));
mcsteps_all = [1 2:2:8]; %setdiff([20:20:100 200:200:1000], [10 100 1000]);
...
% file name of the default initial state (change if necessary!)
fname = fullfile(folder, 'trav_wave_single_vertical_central_position');
% load default initial state
