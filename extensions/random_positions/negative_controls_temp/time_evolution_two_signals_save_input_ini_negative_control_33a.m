...
network = 33; 
appendix = 'a'; % Note special rule for 33a, 33b
...
K_wave_sim_filtered = K_wave_sim(TW_idx_check, :, :);
Con_wave_sim_filtered = Con_wave_sim(TW_idx_check, :);
...
save(fullfile(folder, fname_str), 'N', 'a0', 'hill', 'lambda', 'noise',...
    ...
    'TW_idx_check', 'TW_idx_check_strict', 'M_int', 'p0', 'I0', 'cells_ini',...
    'mcsteps', 'tmax');
fprintf('Saved %s \n', fname_str);
