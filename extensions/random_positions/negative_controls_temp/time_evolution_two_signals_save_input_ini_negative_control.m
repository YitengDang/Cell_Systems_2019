...
K_wave_sim_filtered = K_wave_sim(TW_idx_check_strict, :, :);
Con_wave_sim_filtered = Con_wave_sim(TW_idx_check_strict, :);
...
save(fullfile(folder, fname_str), 'N', 'a0', 'hill', 'lambda', 'noise',...
    'rcell', 'Con_wave_sim_filtered', 'K_wave_sim_filtered', 'M_int');
