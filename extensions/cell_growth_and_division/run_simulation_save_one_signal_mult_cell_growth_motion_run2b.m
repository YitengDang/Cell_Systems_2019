...
% motion of each cell
% --note: run simulations with randomized initial positions, without cell
% motion and cell growth, without noise. Compare with Fig. 4.2 in
% multicellularity extension file 7.--
close all
clear all
% maxNumCompThreads(4);
% warning off
